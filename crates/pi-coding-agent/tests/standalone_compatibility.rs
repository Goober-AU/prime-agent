...
fn background_helper_is_not_active_agent_work_and_backend_is_unchanged() {
    let raw=json!({"id":"child","sessionId":"child-session","cwd":"C:/isolated","lifecycle":"live","runtimeKind":"subagent","activeSessionId":"child-active","parentSessionId":"parent","isSessionActive":true,"activity":"working","isStreaming":false,"isCompacting":false,"isRunningTools":false,"attachedClients":0.0,"messageCount":5.0,"rosterStatus":"running"});
